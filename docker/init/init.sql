...
CREATE TABLE `3DMANAGER_USER` (
  `3DMANAGER_USER_ID` int NOT NULL AUTO_INCREMENT,
...
>>>>>>> release/0.3.0
  PRIMARY KEY (`3DMANAGER_USER_ID`),
  KEY `FK_USER_GROUP_idx` (`3DMANAGER_USER_GROUP_ID`),
  KEY `FK_USER_ROLE_idx` (`3DMANAGER_USER_ROLE`),
  CONSTRAINT `FK_USER_GROUP` FOREIGN KEY (`3DMANAGER_USER_GROUP_ID`) REFERENCES `3DMANAGER_GROUP` (`3DMANAGER_GROUP_ID`),
  CONSTRAINT `FK_USER_ROLE` FOREIGN KEY (`3DMANAGER_USER_ROLE`) REFERENCES `3DMANAGER_C_ROLES` (`3DMANAGER_C_ROLES_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `3DMANAGER_FILAMENT` (
  ...
  `3DMANAGER_FILAMENT_MATERIAL_CHECK` bit(1) DEFAULT b'0',
...
CREATE TABLE `3DMANAGER_INVITATIONS` (
  ...
  CONSTRAINT `FK_INVITATION_USER` FOREIGN KEY (`3DMANAGER_INVITATIONS_USER_ID`) REFERENCES `3DMANAGER_USER` (`3DMANAGER_USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `3DMANAGER_NOTIFICATION` (
  ...
  CONSTRAINT `FK_NOTIFICATION_USER` FOREIGN KEY (`3DMANAGER_NOTIFICATION_USER_ID`) REFERENCES `3DMANAGER_USER` (`3DMANAGER_USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `3DMANAGER_3DPRINT` (
  ...
  `3DMANAGER_3DPRINT_DELETED_DATE` datetime DEFAULT NULL,
  ...
  CONSTRAINT `FK_PRINT_USER` FOREIGN KEY (`3DMANAGER_3DPRINT_USER_ID`) REFERENCES `3DMANAGER_USER` (`3DMANAGER_USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `3DMANAGER_COMMENT` (
  ...
  CONSTRAINT `FK_COMMENT_USER` FOREIGN KEY (`3DMANAGER_COMMENT_USER_ID`) REFERENCES `3DMANAGER_USER` (`3DMANAGER_USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE PROCEDURE `3DMANAGER_pr_CLEAN_OLD_DATA`(
    OUT CodigoError INT
    )
BEGIN
	...
	BEGIN
		...
		VALUES('3DMANAGER_pr_CLEAN_OLD_DATA', v_err_msg);
		COMMIT;
    ...
    SET CodigoError = 0;
    START TRANSACTION;
		DELETE FROM `3DMANAGER_3DPRINT` 
        WHERE `3DMANAGER_3DPRINT_DELETED` = 1 AND `3DMANAGER_3DPRINT_DELETED_DATE` < NOW() - INTERVAL 2 MONTH;
        
        DELETE FROM `3DMANAGER_NOTIFICATION` 
        WHERE `3DMANAGER_NOTIFICATION_IT_READ` = 1 AND `3DMANAGER_NOTIFICATION_REGISTER_DATE` < NOW() - INTERVAL 2 MONTH;
    COMMIT;    
	
END$$

CREATE PROCEDURE `3DMANAGER_pr_COMMENT_DELETE`(
    IN P_CD_COMMENT INT
)
BEGIN

	DELETE FROM `3DMANAGER_COMMENT` WHERE `3DMANAGER_COMMENT_ID` = P_CD_COMMENT;
...
BEGIN
	...
	START TRANSACTION;
		...
		IF( (SELECT `3DMANAGER_USER_GROUP_ID` FROM `3DMANAGER_USER` WHERE `3DMANAGER_USER_ID` = P_CD_USER) IS NULL AND
		...
		THEN
			 IF (P_IT_ACCEPTED)
             THEN
				UPDATE `3DMANAGER_USER` SET `3DMANAGER_USER_GROUP_ID` = P_CD_GROUP,`3DMANAGER_USER_ROLE` = 1 WHERE `3DMANAGER_USER_ID` = P_CD_USER ;
        ...
        END IF;	
    COMMIT;    
	SELECT `3DMANAGER_USER_GROUP_ID` FROM `3DMANAGER_USER` WHERE `3DMANAGER_USER_ID` = P_CD_USER;
END$$
...
BEGIN
	SELECT 
		U.`3DMANAGER_USER_NAME` AS 'USER_OWNER',
        G.`3DMANAGER_GROUP_ID` as 'GROUP_ID',
        G.`3DMANAGER_GROUP_NAME` as 'GROUP_NAME',
        G.`3DMANAGER_GROUP_DESCRIPTION` as 'GROUP_DESCRIPTION'
...
BEGIN
	...
	START TRANSACTION;
        ...
        UPDATE `3DMANAGER_USER` 
			SET `3DMANAGER_USER_GROUP_ID` = null,
			`3DMANAGER_USER_ROLE` = NULL
			WHERE `3DMANAGER_USER_ID` = P_CD_USER_KICKED;
...
BEGIN
	...
	START TRANSACTION;
        ...
        UPDATE `3DMANAGER_USER` 
			SET `3DMANAGER_USER_ROLE` = 1
			WHERE `3DMANAGER_USER_ID` = P_CD_USER AND `3DMANAGER_USER_GROUP_ID` = P_CD_GROUP ;
        
        UPDATE `3DMANAGER_USER` 
			SET `3DMANAGER_USER_ROLE` = 2
			WHERE `3DMANAGER_USER_ID` = P_CD_NEW_OWNER AND `3DMANAGER_USER_GROUP_ID` = P_CD_GROUP;
...
CREATE PROCEDURE `3DMANAGER_pr_NOTIFICATION_INSERT`(
    IN P_USER_ID INT,
...
BEGIN
    ...
    BEGIN
        ...
        START TRANSACTION;
        INSERT INTO `3DMANAGER_SYSTEM_LOGS`(PROCEDURE_NAME, ERROR_MESSAGE)
        VALUES('3DMANAGER_pr_NOTIFICATION_INSERT', v_err_msg);
        COMMIT;
    ...
    SET NEW_ID = LAST_INSERT_ID();
    COMMIT;
    SELECT NEW_ID AS `NOTIFICATION_ID`;
END$$
...
BEGIN
	...
	START TRANSACTION;
        ...
        SET 
         ...
         `3DMANAGER_3DPRINT_DELETED_DATE` = CURRENT_TIMESTAMP()
...
BEGIN
	...
	SELECT 
        ...
        `3DMANAGER_USER_NAME` AS PRINT_USER,
...
BEGIN
	...
	START TRANSACTION;
        ...
        SET 
         ...
         `3DMANAGER_3DPRINT_REAL_IMPRESSION_TIME` = P_NM_REAL_TIME
        WHERE `3DMANAGER_3DPRINT_ID` = P_CD_PRINT AND `3DMANAGER_3DPRINT_GROUP_ID` = P_CD_GROUP;
...
CREATE PROCEDURE `3DMANAGER_pr_PRINT_DELETE_IMAGE`(
    IN P_CD_GROUP INT,
    IN P_CD_PRINT INT
)
BEGIN
	...
	BEGIN
		...
		START TRANSACTION;
		INSERT INTO `3DMANAGER_SYSTEM_LOGS`(PROCEDURE_NAME, ERROR_MESSAGE)
		VALUES('3DMANAGER_pr_PRINT_DELETE_IMAGE', v_err_msg);
		COMMIT;
	...
	START TRANSACTION;
	UPDATE `3DMANAGER_3DPRINT` SET
        `3DMANAGER_3DPRINT_IMAGE_URL` = NULL,
        `3DMANAGER_3DPRINT_IMAGE_KEY` = NULL
    WHERE `3DMANAGER_3DPRINT_GROUP_ID` = P_CD_GROUP and  `3DMANAGER_3DPRINT_ID` = P_CD_PRINT ;
	COMMIT;    
		SELECT `3DMANAGER_3DPRINT_ID` FROM `3DMANAGER_3DPRINT` WHERE P_CD_PRINT = `3DMANAGER_3DPRINT_ID`;
END$$


CREATE PROCEDURE `3DMANAGER_pr_PRINT_GET_IMAGE`(
    IN P_CD_GROUP INT,
    IN P_CD_PRINT INT
)
BEGIN
...
BEGIN
	...
	UPDATE `3DMANAGER_USER` SET
        `3DMANAGER_USER_IMAGE_URL` = NULL,
        `3DMANAGER_USER_IMAGE_KEY` = NULL
<<<<<<< HEAD
    WHERE `3DMANAGER_USER_GROUP_ID` = P_CD_GROUP and  `3DMANAGER_USER_ID` = P_CD_USER ;
=======
    WHERE `3DMANAGER_USER_ID` = P_CD_USER ;
>>>>>>> release/0.3.0
	COMMIT;    
		SELECT `3DMANAGER_USER_ID` FROM `3DMANAGER_USER` WHERE P_CD_USER = `3DMANAGER_USER_ID`;
END$$
...
BEGIN
    ...
    FROM `3DMANAGER_USER` 
<<<<<<< HEAD
    WHERE `3DMANAGER_USER_GROUP_ID` IS NULL
=======
    WHERE `3DMANAGER_USER_GROUP_ID` IS NULL AND  `3DMANAGER_USER_DELETED` = 0
>>>>>>> release/0.3.0
    AND (P_FILTER IS NULL OR `3DMANAGER_USER_NAME` LIKE CONCAT('%', P_FILTER, '%'))
    ORDER BY `3DMANAGER_USER_NAME`
    LIMIT 50;
END ;;

CREATE DEFINER=`root`@`localhost` PROCEDURE `3DMANAGER_pr_USER_LIST`(
    IN P_CD_GROUP INT
)
BEGIN
	SELECT 
		`3DMANAGER_USER_ID`,
        `3DMANAGER_USER_NAME`,
        IFNULL((SELECT SUM(`3DMANAGER_3DPRINT_IMPRESSION_TIME`) FROM `3DMANAGER_3DPRINT` WHERE `3DMANAGER_3DPRINT_GROUP_ID` = P_CD_GROUP AND `3DMANAGER_3DPRINT_USER_ID` = `3DMANAGER_USER_ID` ),0) AS USER_HOURS,
        (SELECT COUNT(*) FROM `3DMANAGER_3DPRINT` WHERE `3DMANAGER_3DPRINT_GROUP_ID` = P_CD_GROUP AND `3DMANAGER_3DPRINT_USER_ID` = `3DMANAGER_USER_ID` ) AS NUMBER_PRINTS
    FROM `3DMANAGER_USER`
    WHERE `3DMANAGER_USER_GROUP_ID` = P_CD_GROUP ;
END$$
...
=======
    WHERE u.`3DMANAGER_USER_NAME` = P_DS_USER_NAME AND u.`3DMANAGER_USER_DELETED` != 1;  
>>>>>>> release/0.3.0
END$$
...
BEGIN
	...
	START TRANSACTION;
		IF EXISTS (
<<<<<<< HEAD
			SELECT 1 FROM `3DMANAGER_USER` WHERE `3DMANAGER_USER_NAME` = P_DS_USER_NAME
=======
...
>>>>>>> release/0.3.0
		...
		ELSE
			INSERT INTO `3DMANAGER_USER` (`3DMANAGER_USER_NAME`,`3DMANAGER_USER_PASSWORD`, `3DMANAGER_USER_EMAIL`)
