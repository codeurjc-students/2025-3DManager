...
{
    public class UserRepository : MySQLManager, IUserRepository
    {
        public UserRepository(IDataSource<MySqlConnection> dataSourceFactory, ILogger<UserRepository> logger)
