...
{
    public class PrinterRepository : MySQLManager, IPrinterRepository
    {
        ...
        public PrinterRepository(IDataSource<MySqlConnection> dataSourceFactory, ILogger<PrinterRepository> logger)
