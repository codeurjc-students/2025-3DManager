...
{
    public class NotificationRepository : MySQLManager, INotificationRepository
    {
        private const string ErrorConstant = "CodigoError";

        public NotificationRepository(IDataSource<MySqlConnection> dataSourceFactory, ILogger<NotificationRepository> logger)
