...
{
    public class CatalogRepository : MySQLManager, ICatalogRepository
    {
        public const string ErrorCodeParam = "CodigoError";
        public CatalogRepository(IDataSource<MySqlConnection> dataSourceFactory, ILogger<CatalogRepository> logger)
