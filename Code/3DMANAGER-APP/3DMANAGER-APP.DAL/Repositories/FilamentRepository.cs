...
{
    public class FilamentRepository : MySQLManager, IFilamentRepository
    {
        private const string ErrorConstant = "CodigoError";
        private const string GroupParam = "P_CD_GROUP";
        public FilamentRepository(IDataSource<MySqlConnection> dataSourceFactory, ILogger<FilamentRepository> logger)
