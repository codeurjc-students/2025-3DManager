...
{
    public class DailyTaskDbManager : MySQLManager, IDailyTaskDbManager
    {
        private const string ErrorConstant = "CodigoError";

        public DailyTaskDbManager(IDataSource<MySqlConnection> dataSourceFactory, ILogger<DailyTaskDbManager> logger) : base(dataSourceFactory, logger)
        {
        }
