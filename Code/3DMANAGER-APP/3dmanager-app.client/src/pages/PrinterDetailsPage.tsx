        ...
        <div className="d-flex flex-column vh-100">
            ...
            <div className="row h-100">
                <div className="col-4 grey-container">
                    <div className="h-50">
                        <div className="title-impact-3 col-1 mt-2 ms-2 w-100 d-flex flex-row justify-content-between">
                        ...
                        <div className="col-4 mt-2 ms-3 mb-5 w-100">
                            <input type="text" className="input-value-3 me-5 w-100" value={model} disabled={!isManager}
                                onChange={(e) => setModel(e.target.value)}/>
                            <input type="textarea" className="input-value-3 me-5 w-100 h-10" value={description} disabled={!isManager}
                                onChange={(e) => setDescription(e.target.value)} />
                        </div>
                    </div>
                    <div className="h-50 ms-3 mt-2">
                        <div className="h-10 mt-2">
                            <div className="d-flex flex row">
                                ...
                                <div className="col-6 mb-3 ">
                                    ...
                                    <div className="d-flex flex-row">
                                        <select id="printerState" className="input-value w-100" value={state} onChange={(e) => { setState(Number(e.target.value)) }}>
                                            {stateData.map(s => (
