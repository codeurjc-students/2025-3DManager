        ...
        <div className="container-fluid vh-100">
            ...
            <div className="row h-40 d-flex justify-content-center">
                <div className="col-10 ms-5 d-flex flex-row justify-content-between">
                    <button type="button" className="botton-low-yellow col-3 ms-5 d-flex flex-column align-items-center justify-content-center" onClick={() => navigate("/createPrinter")}>
                    ...
                    <button type="button" className="botton-low-yellow col-3 ms-5 d-flex flex-column align-items-center justify-content-center" onClick={() => navigate("/createFilament")}>
                        <svg width="93" height="88" viewBox="0 0 93 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M46.5 18.3333V69.6666M19.375 43.9999H73.625" stroke="#1E1E1E" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <span className="dashboard-title mt-4">Agregar filamento</span>
                    </button>
                    <button type="button" className="botton-low-yellow col-3 ms-5 d-flex flex-column align-items-center justify-content-center" onClick={() => navigate("/UserInvitation")}>
