        ...
        <div className="container-fluid vh-100">
            ...
            <div className="row h-40 d-flex justify-content-center">
                <div className="col-10 ms-5 d-flex flex-row justify-content-between">
                    ...
                    <button type="button" className="botton-low-yellow col-3 ms-5 d-flex flex-column align-items-center justify-content-center" onClick={() => navigate("/dashboard/user-invitation")}>
