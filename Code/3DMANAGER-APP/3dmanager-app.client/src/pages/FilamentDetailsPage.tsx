...
import { deleteFilament, getFilamentDetail, updateFilament } from "../api/filamentService";
                        ...
                        if (response.data) {
                            showPopup({
                                ...
                                content: (
                                    <InfoPopup
                                        ...
                                        description="El filamento ha sido eliminado correctamente."
                                    />
                                ),
                                onClose: () => {
                                    closePopup();
                            ...
                            showPopup({
                                ...
                                content: (
                                    <InfoPopup
                                        title="Error"
                                        description={response.error?.message || "No se pudo eliminar el filamento."}
                                    />
                                ),
                                onClose: () => closePopup()
                            });
