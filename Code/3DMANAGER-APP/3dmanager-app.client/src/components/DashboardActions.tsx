        ...
        <div>
            ...
            <div className="d-flex align-items-center">
                <div className="col-4 d-flex flex-column align-items-center">
                    <button type="button" className="botton-darkGrey  dashboard-icon-btn" onClick={() => navigate("/dashboard/lists/filaments")}>
                ...
                <div className="col-4 d-flex flex-column align-items-center">
                    <button type="button" className="botton-darkGrey  dashboard-icon-btn" onClick={() => navigate("/dashboard/lists/users")}>
                ...
                <div className="col-4 d-flex flex-column align-items-center">
                    <button type="button" className="botton-darkGrey dashboard-icon-btn" onClick={() => navigate("/dashboard/lists/prints")}>
            ...
            <div>
                {user!.rolId == "Usuario-Manager" ? (
                    <div className="d-flex align-items-center mt-1 justify-content-between">
                        <button type="button" className="botton-yellow dashboard-icon-btn col-5 ms-5" onClick={() => navigate("/dashboard/print-create")}>
                            ...
                            <button type="button" className="botton-yellow dashboard-icon-btn col-5 me-5" onClick={() => navigate("/dashboard/add")}>
