    ...
    return (
        <div>
            ...
            <div className="d-flex align-items-start">
                <div className="ms-5">
                    <button type="button" className="button-darkGrey  dashboard-icon-btn mt-3 mb-3" onClick={() => navigate("/dashboard/lists/filaments")}>
                        <svg className="col-4" width="60" height="60" viewBox="0 0 94 91" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="col-8 dashboard-title-w ms-3">Listado filamentos</span>
                    </button>
                    <button type="button" className="button-darkGrey  dashboard-icon-btn mb-3" onClick={() => navigate("/dashboard/lists/users")}>
                        <svg className="col-4" width="60" height="60" viewBox="0 0 98 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="col-8 dashboard-title-w ms-3">Listado usuarios</span>
                    </button>
                    <button type="button" className="button-darkGrey dashboard-icon-btn " onClick={() => navigate("/dashboard/lists/prints")}>
                        <svg className="col-4" width="65" height="65" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="col-8 dashboard-title-w ms-3">Listado impresiones</span>
                    </button>
                </div>
                <div className="ms-5">
                    {user!.rolId == "Usuario-Manager" ? (
                        <div>
                            <button type="button" className="button-yellow dashboard-icon-btn mb-3 mt-3" onClick={() => navigate("/dashboard/print-create")}>                              
                                <svg className="col-4" width="60" height="60" viewBox="0 0 45 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.625 26.25V33.25C5.625 34.1783 6.02009 35.0685 6.72335 35.7249C7.42661 36.3813 8.38044 36.75 9.375 36.75L35.625 36.75C36.6196 36.75 37.5734 36.3813 38.2767 35.7249C38.9799 35.0685 39.375 34.1783 39.375 33.25V26.25M13.125 14L22.5 5.25M22.5 5.25L31.875 14M22.5 5.25L22.5 26.25" stroke="#000000" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            ...
                            <button type="button" className="button-yellow dashboard-icon-btn mt-3" onClick={() => handleAddInventory()}>                              
                                ...
                                <span className="col-8 dashboard-title-b pe-5">Añadir</span>
                            </button>

                        </div>
                    ) : (                
                            <button disabled={!permission} type="button" className={`mt-3 justify-content-center dashboard-icon-btn ${!permission ? "button-darkGrey-low " : "button-yellow"
                                }`} onClick={() => navigate("/dashboard/print-create")}>
                                <svg className="col-4" width="45" height="42" viewBox="0 0 45 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.625 26.25V33.25C5.625 34.1783 6.02009 35.0685 6.72335 35.7249C7.42661 36.3813 8.38044 36.75 9.375 36.75L35.625 36.75C36.6196 36.75 37.5734 36.3813 38.2767 35.7249C38.9799 35.0685 39.375 34.1783 39.375 33.25V26.25M13.125 14L22.5 5.25M22.5 5.25L31.875 14M22.5 5.25L22.5 26.25" stroke="#000000" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <span className="col-8 dashboard-title-b pe-5">Subir impresión</span>
                            </button>                       
